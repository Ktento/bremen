...
class GroupTracksControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create group_track' do
    assert_difference('GroupTrack.count') do
      post group_tracks_url,
           params: { group_track: { Group_id: @group_track.Group_id, Track_id: @group_track.Track_id, listen_count: @group_track.listen_count } }, as: :json
    end
  ...
  test 'should update group_track' do
    patch group_track_url(@group_track),
          params: { group_track: { Group_id: @group_track.Group_id, Track_id: @group_track.Track_id, listen_count: @group_track.listen_count } }, as: :json
    assert_response :success
  end
