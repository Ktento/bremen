...
class GroupUsersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create group_user" do
    assert_difference("GroupUser.count") do
      post group_users_url, params: { group_user: { group_id_id: @group_user.group_id_id, user_id_id: @group_user.user_id_id } }, as: :json
    end
  ...
  test "should update group_user" do
    patch group_user_url(@group_user), params: { group_user: { group_id_id: @group_user.group_id_id, user_id_id: @group_user.user_id_id } }, as: :json
    assert_response :success
  end
