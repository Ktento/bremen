...
class UserTracksControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create user_track' do
    assert_difference('UserTrack.count') do
      post user_tracks_url, params: { user_track: { Group_id: @user_track.Group_id, User_id: @user_track.User_id } },
                            as: :json
    end
  ...
  test 'should update user_track' do
    patch user_track_url(@user_track),
          params: { user_track: { Group_id: @user_track.Group_id, User_id: @user_track.User_id } }, as: :json
    assert_response :success
  end
